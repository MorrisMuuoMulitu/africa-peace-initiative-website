        ...
        <section className="py-12 px-4 sm:px-6 bg-gradient-to-r from-api-terracotta/10 to-api-gold/5">
          <div className="max-w-7xl mx-auto">
            <a 
              ...
              className="block"
              onMouseEnter={() => setGooglePhotosHovered(true)}
              onMouseLeave={() => setGooglePhotosHovered(false)}
              onClick={(e) => {
            ...
            >
              <div className={cn(
                "relative overflow-hidden rounded-xl border border-api-terracotta/20 shadow-lg transition-all duration-500",
                googlePhotosHovered ? "shadow-xl shadow-api-terracotta/20 scale-[1.01]" : ""
              )}>
                {/* Background pattern */}
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-8 md:p-10 overflow-hidden">
                  <div className="flex-1 mb-6 md:mb-0 mr-0 md:mr-8 text-center md:text-left">
                    ...
                    <div className={cn(
                      "inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-5 py-3 rounded-full transition-all duration-500",
                      googlePhotosHovered ? "bg-api-terracotta text-white" : "text-white"
                    )}>
                      <span>View Full Album</span> 
                      <ExternalLink size={16} className={cn(
                        "transition-all duration-500",
                        googlePhotosHovered ? "translate-x-1" : ""
                      )} />
                    </div>
                  </div>
                  ...
                  <div className="relative h-52 md:h-64 w-full md:w-80 lg:w-96 perspective-1000">
                    <div className={cn(
                      "absolute top-0 left-0 h-40 w-32 md:h-48 md:w-40 rounded-lg shadow-lg transform rotate-[-6deg] transition-all duration-700",
                    ...
                    <div className={cn(
                      "absolute top-0 left-1/4 h-44 w-36 md:h-52 md:w-44 rounded-lg shadow-lg transform rotate-[3deg] z-20 transition-all duration-700",
                    ...
                    <div className={cn(
                      "absolute top-4 left-1/2 h-36 w-32 md:h-44 md:w-40 rounded-lg shadow-lg transform rotate-[10deg] z-10 transition-all duration-700",
