...
const Event = () => {
  ...
  return (
    <div ref={ref} id="events" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-api-cream/20">
      <div className={`max-w-6xl mx-auto transition-all duration-700 transform ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          ...
          <Button variant="outline" className="mt-6 md:mt-0 border-api-terracotta text-api-terracotta hover:bg-api-terracotta/10" asChild>
            <Link to="/events">
        ...
        <Card 
          className={`overflow-hidden border-none rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 ${inView ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
