...
const Navbar = () => {
  ...
  return (
    <nav className={`py-3 px-4 sm:px-6 sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-api-forest shadow-md' : 'bg-api-forest bg-opacity-90 backdrop-blur-sm'}`}>
