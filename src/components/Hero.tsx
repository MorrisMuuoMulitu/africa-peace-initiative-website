        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className={`lg:col-span-7 text-left transition-all duration-1000 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="flex items-center mb-6">
              ...
              <span className="text-api-ivory font-medium tracking-wider uppercase text-sm animate-slide-left" style={{ animationDelay: '0.3s' }}>Africa Peace Initiative</span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold font-montserrat text-api-cream mb-6 lg:mb-8 leading-tight animate-slide-left" style={{ animationDelay: '0.5s' }}>
            ...
            <p className="text-lg md:text-xl lg:text-2xl font-lora text-api-ivory/95 mb-8 lg:mb-10 max-w-xl animate-slide-left leading-relaxed" style={{ animationDelay: '0.7s' }}>
              Creating stability through dialogue, community action, and collaborative diplomacy—transforming conflict into cooperation
            </p>
            
            <div className="flex flex-wrap gap-4 lg:gap-5 animate-slide-left" style={{ animationDelay: '0.9s' }}>
              <Button 
                onClick={scrollToMission}
                className="bg-api-terracotta hover:bg-api-terracotta/90 text-white font-semibold px-6 sm:px-8 py-5 sm:py-6 rounded-md shadow-lg hover:shadow-xl transition-all duration-300 text-base sm:text-lg group"
              >
                Our Approach
              ...
              <Button 
                ...
                variant="outline"
                className="bg-api-darkgreen/40 hover:bg-api-green/30 border-2 border-api-ivory text-white font-semibold px-6 sm:px-8 py-5 sm:py-6 rounded-md transition-all duration-300 text-base sm:text-lg"
              >
                Join Our Efforts
              </Button>
            </div>
            
            <div className="mt-16 lg:mt-20 hidden lg:flex items-center text-api-ivory/90 animate-slide-left" style={{ animationDelay: '1.1s' }}>
