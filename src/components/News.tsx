...
const News = () => {
  ...
  const eventItem = {
    ...
    report: {
      ...
      outcomes: [
        "Creation of a cross-border community engagement framework",
        "Establishment of a regional early warning system for conflict prevention",
        "Development of policy recommendations for the East African Community",
        "Formation of a youth ambassador program for peace advocacy"
      ],
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 lg:p-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  Register for Updates <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button 
                      variant="outline" 
                      className="border-api-green text-api-green hover:bg-api-green/10 rounded-full px-6"
                    >
                    ...
                    <div className="py-4 space-y-6">
                      ...
                      <div>
                        ...
                        <ul className="list-disc pl-5 space-y-2 text-api-charcoal">
                          {eventItem.report.outcomes.map((outcome, index) => (
                      ...
                      <div className="pt-4">
                        <Button 
                          className="w-full bg-api-green hover:bg-api-darkgreen text-white"
                          asChild
                        >
